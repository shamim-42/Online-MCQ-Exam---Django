...
class Token(models.Model):
    ...
    device_token = models.CharField(
        max_length=512, verbose_name="Device Token")
    created_at = models.DateTimeField(
        auto_now=False, auto_now_add=True, verbose_name='Created At')
...
class UserExam(models.Model):
    ...
    fk_user = models.ForeignKey(
        "tokens.User", on_delete=models.CASCADE, null=True)
    fk_exam = models.ForeignKey(
        "tokens.Exam", on_delete=models.CASCADE, null=True)
    STATUS = [
        ('done', 'Done')
...
class UserExamDetail(models.Model):
    fk_userexam = models.ForeignKey(
        "tokens.UserExam", on_delete=models.CASCADE, null=True)
    fk_question = models.ForeignKey(
        "tokens.Question", on_delete=models.CASCADE, null=True)
